    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8">Professional experience and qualifications</p>
        ...
        >
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              ...
              <p className="text-center text-gray-300 text-lg">Next-Gen Full Stack Developer</p>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {Object.entries(skills).map(([category, skillList]) => (
              <Card key={category} className="bg-gray-800 border-gray-700">
                <CardHeader>
                  <CardTitle className="text-lg text-blue-400">{category}</CardTitle>
                </CardHeader>
                <CardContent>
